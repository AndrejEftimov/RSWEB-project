...
namespace RSWEB_project.Migrations
{
    ...
    [Migration("20200522030219_MigFinal")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RSWEB_project.Models.Course", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("RSWEB_project.Models.Enrollment", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("RSWEB_project.Models.Student", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("RSWEB_project.Models.Teacher", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("RSWEB_project.Models.Course", b =>
                {
                    b.HasOne("RSWEB_project.Models.Teacher", "Teacher1")
                        .WithMany("Courses1")
                        .HasForeignKey("FirstTeacherId");

                    b.HasOne("RSWEB_project.Models.Teacher", "Teacher2")
                        .WithMany("Courses2")
            ...
            modelBuilder.Entity("RSWEB_project.Models.Enrollment", b =>
                {
                    b.HasOne("RSWEB_project.Models.Course", "Course")
                        .WithMany("Enrollments")
                        .HasForeignKey("CourseId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("RSWEB_project.Models.Student", "Student")
                        .WithMany("Enrollments")
